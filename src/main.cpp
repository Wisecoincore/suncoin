...
uint256 hashGenesisBlock("0xe9fa4ca452a0fb59f8273fdd73c4dee3cf9b17d615f9e0b24f0b9bd20281f9b3");
...
static const int64 nTargetTimespan = 6 * 60 * 60; // SunCoin: 6 hours
static const int64 nTargetSpacing = 60; // SunCoin: 60 second blocks
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
        ...
        if (fTestNet) {
                ...
                if (pindexLast->nHeight+1 >= 21210) { DiffMode = 2; }
        }
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x3fd8389afcc61119dc9c70217fafdbb04f91f887050f3707c80691e17e42aafa");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        assert(block.hashMerkleRoot == uint256("0x2bc1659f7c5cfbbe97b3212bb074ed736d4b52d5b86ba370e77f0ae83754062e"));
